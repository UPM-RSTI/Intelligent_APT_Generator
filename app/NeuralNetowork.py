...
class DQNModel(tf.keras.Model):
    def __init__(self,num_actions,_learning_rate):
        ...
        self.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=_learning_rate), loss='mse')
...
class DQNAgent:
    def __init__(self, actions, num_actions,_learning_rate):
        ...
        self.batch_size = 512
        self.model = DQNModel(self.num_actions,_learning_rate)
        self.optimizer = tf.keras.optimizers.Adam(learning_rate=_learning_rate)
